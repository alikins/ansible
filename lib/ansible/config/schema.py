base_defs = \
    {'ACTION_WARNINGS': {'default': True,
                         'description': ['By default Ansible will issue a warning when recieved from a task action (module or action plugin)',
     ...
     'ANSIBLE_COW_PATH': {'default': None,
                          ...
                          'ini': [{'key': 'cowpath', 'section': 'defaults'}],
     ...
     'ANSIBLE_COW_WHITELIST': {'default': ['bud-frogs',
                                           'bunny',
                                           'cheese',
                                           'daemon',
                                           'default',
    ...
    'ANSIBLE_NOCOLOR': {'default': False,
                        ...
                        'ini': [{'key': 'nocolor', 'section': 'defaults'}],
    ...
    'ANSIBLE_NOCOWS': {'default': False,
                       ...
                       'ini': [{'key': 'nocows', 'section': 'defaults'}],
                       'name': 'Suppress cowsay output',
                       'type': 'boolean',
                       'yaml': {'key': 'display.i_am_no_fun'}},
    'ANSIBLE_PIPELINING': {'default': False,
                           'description': ['Pipelining, if supported by the connection plugin, reduces the number of network operations required to execute a module on the remote server, by executing many Ansible modules without actual file transfer.',
    ...
    'ANSIBLE_SSH_ARGS': {'default': '-C -o ControlMaster=auto -o ControlPersist=60s',
                         'description': ['If set, this will override the Ansible default ssh arguments.',
    ...
    'ANSIBLE_SSH_CONTROL_PATH': {'default': None,
                                 'description': ["This is the location to save ssh's ControlPath sockets, it uses ssh's variable substitution.",
    ...
    'ANSIBLE_SSH_CONTROL_PATH_DIR': {'default': '~/.ansible/cp',
                                     'description': ['This sets the directory to use for ssh control path if the control path setting is null.',
    ...
    'ANSIBLE_SSH_EXECUTABLE': {'default': 'ssh',
                               'description': ['This defines the location of the ssh binary. It defaults to `ssh` which will use the first ssh binary available in $PATH.',
    ...
    'ANY_ERRORS_FATAL': {'default': False,
                         ...
                         'env': [{'name': 'ANSIBLE_ANY_ERRORS_FATAL'}],
    ...
    'CACHE_PLUGIN': {'default': 'memory',
                     ...
                     'ini': [{'key': 'fact_caching', 'section': 'defaults'}],
    ...
    'COLOR_DEPRECATE': {'default': 'purple',
                        ...
                        'ini': [{'key': 'deprecate', 'section': 'colors'}],
    ...
    'COLOR_DIFF_ADD': {'default': 'green',
                        ...
                        'ini': [{'key': 'diff_add', 'section': 'colors'}],
    ...
    'COLOR_VERBOSE': {'default': 'blue',
                    ...
                    'ini': [{'key': 'verbose', 'section': 'colors'}],
                    'name': 'Color for verbose messages'},
    'COLOR_WARN': {'default': 'bright purple',
                    'description': 'Defines the color to use when emitting warning messages',
                    'env': [{'name': 'ANSIBLE_COLOR_WARN'}],
                    'ini': [{'key': 'warn', 'section': 'colors'}],
                    'name': 'Color for warning messages'},
    'COMMAND_WARNINGS': {'default': True,
                        'description': ['By default Ansible will issue a warning when the shell or command module is used and the command appears to be similar to an existing Ansible module.',
                        ...
                        'type': 'boolean',
                        'version_added': '1.8'},
    'DEFAULT_ACTION_PLUGIN_PATH': {'default': '~/.ansible/plugins/action:/usr/share/ansible/plugins/action',
    ...
    'DEFAULT_ALLOW_UNSAFE_LOOKUPS': {'default': False,
                                    'description': ["When enabled, this option allows lookup plugins (whether used in variables as ``{{lookup('foo')}}`` or as a loop as with_foo) to return data that is not marked 'unsafe'.",
    ...
    'DEFAULT_ASK_PASS': {'default': False,
                        ...
                        'ini': [{'key': 'ask_pass', 'section': 'defaults'}],
    ...
    'DEFAULT_CACHE_PLUGIN_PATH': {'default': '~/.ansible/plugins/cache:/usr/share/ansible/plugins/cache',
    ...
    'DEFAULT_CALLABLE_WHITELIST': {'default': [],
                                    ...
                                    'type': 'list'},
    'DEFAULT_CALLBACK_PLUGIN_PATH': {'default': '~/.ansible/plugins/callback:/usr/share/ansible/plugins/callback',
    ...
    'DEFAULT_CONNECTION_PLUGIN_PATH': {'default': '~/.ansible/plugins/connection:/usr/share/ansible/plugins/connection',
    ...
    'DEFAULT_DEBUG': {'default': False,
                    ...
                    'ini': [{'key': 'debug', 'section': 'defaults'}],
                    'name': 'Debug mode',
                    'type': 'boolean'},
    'DEFAULT_EXECUTABLE': {'default': '/bin/sh',
                            ...
                            'ini': [{'key': 'executable', 'section': 'defaults'}],
                            'name': 'Target shell executable'},
    'DEFAULT_FACT_PATH': {'default': None,
                        'description': ["This option allows you to globally configure a custom path for 'local_facts' for the implied M(setup) task when using fact gathering.",
                        ...
                        'ini': [{'key': 'fact_path', 'section': 'defaults'}],
                        'name': 'local fact path',
                        'type': 'path',
                        'yaml': {'key': 'facts.gathering.fact_path'}},
    'DEFAULT_FILTER_PLUGIN_PATH': {'default': '~/.ansible/plugins/filter:/usr/share/ansible/plugins/filter',
    ...
    'DEFAULT_FORCE_HANDLERS': {'default': False,
                                'description': ['This option controls if notified handlers run on a host even if a failure occurs on that host.',
    ...
    'DEFAULT_FORKS': {'default': 5,
                    ...
                    'ini': [{'key': 'forks', 'section': 'defaults'}],
                    'name': 'Number of task forks',
                    'type': 'integer'},
    'DEFAULT_GATHERING': {'choices': ['smart', 'explicit', 'implicit'],
                        'default': 'implicit',
                        'description': ['This setting controls the default policy of fact gathering (facts discovered about remote systems).',
                        ...
                        'ini': [{'key': 'gathering', 'section': 'defaults'}],
                        'name': 'Gathering behaviour',
                        'version_added': '1.6'},
    'DEFAULT_GATHER_SUBSET': {'default': 'all',
                            'description': ['Set the `gather_subset` option for the M(setup) task in the implicit fact gathering. See the module documentation for specifics.',
    ...
    'DEFAULT_GATHER_TIMEOUT': {'default': 10,
                                'description': ['Set the timeout in seconds for the implicit fact gathering.',
                                                'It does **not** apply to user defined M(setup) tasks.'],
    ...
    'DEFAULT_HANDLER_INCLUDES_STATIC': {'default': False,
                                        ...
                                        'type': 'boolean'},
    'DEFAULT_HASH_BEHAVIOUR': {'choices': ['replace', 'merge'],
                                'default': 'replace',
                                'description': ['This setting controls how variables merge in Ansible. By default Ansible will override variables in specific precedence orders, as described in Variables. When a variable of higher precedence wins, it will replace the other value.',
    ...
    'DEFAULT_INTERNAL_POLL_INTERVAL': {'default': 0.001,
                                        ...
                                        'type': 'float',
                                        'version_added': '2.2'},
    'DEFAULT_INVENTORY_PLUGIN_PATH': {'default': '~/.ansible/plugins/inventory:/usr/share/ansible/plugins/inventory',
    ...
    'DEFAULT_LOAD_CALLBACK_PLUGINS': {'default': False,
                                    ...
                                    'type': 'boolean',
                                    'version_added': '1.8'},
    'DEFAULT_LOCAL_TMP': {'default': '~/.ansible/tmp',
                        'description': 'Temporary directory for Ansible to use on the controller.',
                        'env': [{'name': 'ANSIBLE_LOCAL_TEMP'}],
                        'ini': [{'key': 'local_tmp', 'section': 'defaults'}],
                        'name': 'Controller temporary directory',
                        'type': 'tmppath'},
    'DEFAULT_LOG_PATH': {'default': '',
                        'description': 'File to which Ansible will log on the controller. When empty logging is disabled.',
                        'env': [{'name': 'ANSIBLE_LOG_PATH'}],
                        'ini': [{'key': 'log_path', 'section': 'defaults'}],
                        'name': 'Ansible log file path',
                        'type': 'path'},
    'DEFAULT_LOOKUP_PLUGIN_PATH': {'default': '~/.ansible/plugins/lookup:/usr/share/ansible/plugins/lookup',
    ...
    'DEFAULT_MODULE_PATH': {'default': '~/.ansible/plugins/modules:/usr/share/ansible/plugins/modules',
                            ...
                            'ini': [{'key': 'library', 'section': 'defaults'}],
                            'name': 'Modules Path',
                            'type': 'pathspec'},
    'DEFAULT_MODULE_SET_LOCALE': {'default': False,
                                ...
                                'name': 'Target locale',
                                'type': 'boolean'},
    'DEFAULT_MODULE_UTILS_PATH': {'default': '~/.ansible/plugins/module_utils:/usr/share/ansible/plugins/module_utils',
    ...
    'DEFAULT_NO_LOG': {'default': False,
                        ...
                        'ini': [{'key': 'no_log', 'section': 'defaults'}],
                        'name': 'No log',
                        'type': 'boolean'},
    ...
    'DEFAULT_REMOTE_TMP': {'default': '~/.ansible/tmp',
                            'description': ['Temporary directory to use on targets when executing tasks.',
                            ...
                            'ini': [{'key': 'remote_tmp', 'section': 'defaults'}],
                            'name': 'Target temporary directory',
                            'vars': [{'name': 'ansible_remote_tmp'}]},
    'DEFAULT_REMOTE_USER': {'default': None,
                            'description': ['Sets the login user for the target machines',
                                            "When blank it uses the connection plugin's default, normally the user currently executing Ansible."],
                            'env': [{'name': 'ANSIBLE_REMOTE_USER'}],
                            'ini': [{'key': 'remote_user',
                                    'section': 'defaults'}],
                            'name': 'Login/Remote User'},
    'DEFAULT_ROLES_PATH': {'default': '~/.ansible/roles:/usr/share/ansible/roles:/etc/ansible/roles',
                            'description': 'Colon separated paths in which Ansible will search for Roles.',
                            'env': [{'name': 'ANSIBLE_ROLES_PATH'}],
                            'expand_relative_paths': True,
                            'ini': [{'key': 'roles_path', 'section': 'defaults'}],
                            'name': 'Roles path',
                            'type': 'pathspec',
                            'yaml': {'key': 'defaults.roles_path'}},
    'DEFAULT_SCP_IF_SSH': {'default': 'smart',
                            'description': ['Prefered method to use when transfering files over ssh',
    ...
    'DEFAULT_SELINUX_SPECIAL_FS': {'default': 'fuse, nfs, vboxsf, ramfs, 9p',
                                    'description': ["Some filesystems do not support safe operations and/or return inconsistent errors, this setting makes Ansible 'tolerate' those in the list w/o causing fatal errors.",
    ...
    'DEFAULT_STDOUT_CALLBACK': {'default': 'default',
                                'description': ['Set the main callback used to display Ansible output, you can only have one at a time.',
    ...
    'DEFAULT_STRATEGY': {'default': 'linear',
                        ...
                        'ini': [{'key': 'strategy', 'section': 'defaults'}],
                        'name': 'Implied strategy',
                        'version_added': '2.3'},
    'DEFAULT_STRATEGY_PLUGIN_PATH': {'default': '~/.ansible/plugins/strategy:/usr/share/ansible/plugins/strategy',
    ...
    'DEFAULT_SUDO_EXE': {'default': 'sudo',
                        ...
                        'ini': [{'key': 'sudo_exe', 'section': 'defaults'}],
    ...
    'DEFAULT_SUDO_FLAGS': {'default': '-H -S -n',
                            ...
                            'ini': [{'key': 'sudo_flags', 'section': 'defaults'}],
                            'name': 'sudo flags'},
    'DEFAULT_SUDO_USER': {'default': None,
                        ...
                        'ini': [{'key': 'sudo_user', 'section': 'defaults'}],
                        'name': 'sudo user'},
    'DEFAULT_SU_EXE': {'default': 'su',
                        ...
                        'ini': [{'key': 'su_exe', 'section': 'defaults'}],
                        'name': 'su executable'},
    'DEFAULT_SU_FLAGS': {'default': '',
                        ...
                        'ini': [{'key': 'su_flags', 'section': 'defaults'}],
                        'name': 'su flags'},
    'DEFAULT_SU_USER': {'default': None,
                        ...
                        'ini': [{'key': 'su_user', 'section': 'defaults'}],
                        'name': 'su user'},
    ...
    'DEFAULT_TASK_INCLUDES_STATIC': {'default': False,
                                    ...
                                    'type': 'boolean',
                                    'version_added': '2.1'},
    'DEFAULT_TEST_PLUGIN_PATH': {'default': '~/.ansible/plugins/test:/usr/share/ansible/plugins/test',
    ...
    'DEFAULT_TIMEOUT': {'default': 10,
                        ...
                        'ini': [{'key': 'timeout', 'section': 'defaults'}],
    ...
    'DEFAULT_TRANSPORT': {'default': 'smart',
                        ...
                        'ini': [{'key': 'transport', 'section': 'defaults'}],
                        'name': 'Connection plugin'},
    'DEFAULT_UNDEFINED_VAR_BEHAVIOR': {'default': True,
                                        'description': ['When True, this causes ansible templating to fail steps that reference variable names that are likely typoed.',
                                        ...
                                        'type': 'boolean',
                                        'version_added': '1.3'},
    'DEFAULT_VARS_PLUGIN_PATH': {'default': '~/.ansible/plugins/vars:/usr/share/ansible/plugins/vars',
    ...
    'DEFAULT_VERBOSITY': {'default': 0,
                        ...
                        'ini': [{'key': 'verbosity', 'section': 'defaults'}],
                        'name': 'Verbosity',
                        'type': 'integer'},
    ...
    'ENABLE_TASK_DEBUGGER': {'default': False,
                            'description': ['Whether or not to enable the task debugger, this previously was done as a strategy plugin.',
    ...
    'INJECT_FACTS_AS_VARS': {'default': True,
                            'description': ['Facts are available inside the `ansible_facts` variable, this setting also pushes them as their own vars in the main namespace.',
                            ...
                            'type': 'boolean',
                            'version_added': '2.5'},
    'INVENTORY_ENABLED': {'default': ['host_list',
                                    'script',
                                    'yaml',
                                    'ini',
                                    'auto'],
    ...
    'MERGE_MULTIPLE_CLI_TAGS': {'default': True,
                                'description': ['This allows changing how multiple --tags and --skip-tags arguments are handled on the command line. In Ansible up to and including 2.3, specifying --tags more than once will only take the last value of --tags.',
                                ...
                                'type': 'bool',
                                'version_added': '2.3'},
    'NETWORK_GROUP_MODULES': {'default': ['eos',
                                        'nxos',
                                        'ios',
                                        'iosxr',
                                        'junos',
    ...
    'PERSISTENT_CONNECT_TIMEOUT': {'default': 30,
                                    ...
                                    'type': 'integer'},
    'PERSISTENT_CONTROL_PATH_DIR': {'default': '~/.ansible/pc',
                                    ...
                                    'type': 'path'},
    'PLAYBOOK_VARS_ROOT': {'choices': ['top', 'bottom', 'all'],
                            'default': 'top',
                            'description': ['This sets which playbook dirs will be used as a root to process vars plugins, which includes finding host_vars/group_vars',
    ...
    'SHOW_CUSTOM_STATS': {'default': False,
                        ...
                        'type': 'bool'},
    'STRING_TYPE_FILTERS': {'default': ['string',
                                        'to_json',
                                        'to_nice_json',
                                        'to_yaml',
                                        'ppretty',
    ...
    'USE_PERSISTENT_CONNECTIONS': {'default': False,
                                    ...
                                    'name': 'Persistence',
                                    'type': 'boolean'},
    'VARIABLE_PRECEDENCE': {'default': ['all_inventory',
                                        'groups_inventory',
    ...
    'YAML_FILENAME_EXTENSIONS': {'default': ['.yml', '.yaml', '.json'],
                                'description': ["Check all of these extensions when looking for 'variable' files which should be YAML or JSON or vaulted versions of these.",
                                                'This affects vars_files, include_vars, inventory and vars plugins among others.'],
                                'env': [{'name': 'ANSIBLE_YAML_FILENAME_EXT'}],
