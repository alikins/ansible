            ...
            def _plugins_inventory(entities):
                ...
                for inventory_dir in self._inventory._sources:
                    ...
                    for plugin in vars_loader.all():
                        data = combine_vars(data, _get_plugin_vars(plugin, inventory_dir, entities), name_b='inventory_plugins')
                return data
            ...
            def _plugins_play(entities):
                ...
                for plugin in vars_loader.all():
                    for path in basedirs:
                        ...
                        data = combine_vars(data, _get_plugin_vars(plugin, path, entities), name_b='plugins_play')
                return data
